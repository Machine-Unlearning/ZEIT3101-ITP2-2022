...
class BOLT(ToyV2):
    ...
    listen_for_robot_to_robot_infrared_message = partialmethod(Sensor.listen_for_robot_to_robot_infrared_message, proc=Processors.SECONDARY)  # ListenForRobotToRobotInfraredMessageCommand
