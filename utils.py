...
class ToyUtil:
    ...
    def send_robot_to_robot_infrared_message(toy: Toy, channel: int, intensity: int,
                                             not_supported_handler: Callable[[], None] = None):
        if toy.implements(Sensor.send_robot_to_robot_infrared_message): # BOLT
    ...
    def listen_for_robot_to_robot_infrared_message(toy: Toy, channels: Iterable[int], duration: int,
        ...
        if toy.implements(Sensor.listen_for_robot_to_robot_infrared_message ):# BOLT
            for channel in channels:
                toy.listen_for_robot_to_robot_infrared_message(channel, duration) 
